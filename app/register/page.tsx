        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12 xl:p-16">
          ...
          <div className="mb-12">
            <h2 className="mb-6 font-serif text-4xl font-bold leading-tight text-white xl:text-5xl">
              Start your ShopEase <br /> journey
            </h2>
            <p className="max-w-md text-lg text-zinc-300">
              Create your account to save favorites, track orders, and enjoy a seamless shopping experience.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-4 py-12 sm:px-8 lg:w-1/2">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-2 text-center lg:text-left">
            <h1 className="font-serif text-3xl font-bold tracking-tight lg:text-4xl">Join ShopEase</h1>
            <p className="text-muted-foreground text-sm">Create your account and start shopping smarter</p>
          </div>
